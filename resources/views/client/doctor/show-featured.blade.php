...
@section('title')
    Our Featured Doctors | Doctor Appointments
@endsection
@section('content')
                            ...
                            <div class="breadcrumb-area">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Our Featured Doctors</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center ml-b-30">
                    <div class="col-lg-3 col-md-6 col-sm-6 mrb-30">
                        <div class="booking-item">
                            <div class="booking-thumb">
                                <img src="{{ asset('client') }}/assets/doctor/images/profile/605f15f99f1921616844281.jpg"
                                    alt="booking">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mrb-30">
                        <div class="booking-item">
                            <div class="booking-thumb">
                                <img src="{{ asset('client') }}/assets/doctor/images/profile/605f162d78c7c1616844333.jpg"
                                    alt="booking">
